        ...
        <title>Welcome to CEG Admin</title>
        ...
        .account-pages
        {
        background: url(../assets/image/admin_bg.png);
        position: absolute;
        height: 100%;
        width: 100%;
    ...
    margin: 30px auto;
        ...
        <h3 class="text-center"> <img style="width: 50%;" src="<?php echo base_url(); ?>assets/image/ceg.png" class="logo_head"/></h3>
        </div>
