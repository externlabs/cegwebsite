...
<script type="text/javascript">
	$(document).ready(function(){
	   	var userDataTable = $('#lowinventory').DataTable({
	      	...
	      	'pageLength':25,
	      	'ajax': {
	          'url':'<?=base_url()?>admin/faculity/faculityinformation/addinventory_api',
	          'data': function(data){
  ...
  $(document).on('change', '#change_status', function() {
      ...
      var id = $("#faculity_id").val();  
      $.ajax({  
         type:"POST",  
         url:'<?=base_url()?>admin/faculity/faculityinformation/update_faculity',  
