...
<div class="date_filter">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="<?php echo base_url();?>admin/company/add"><button class="ad">+</button></a>
            </div>
        </div>    
        <div class="row">
            <div class="col-md-12">
...
<div id="deletePurchaseModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <?php echo form_open(base_url('admin/company/allcompany/deletepost'), array('method'=>'post'));?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h4><b>Do you really want to Delete this Company ?</b></h4>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
	$(document).ready(function(){
	   	var userDataTable = $('#lowinventory').DataTable({
	      	...
	      	'pageLength':25,
	      	'ajax': {
	          'url':'<?=base_url()?>admin/company/allcompany/addinventory_api',
	          'data': function(data){
  ...
  $(document).on('change', '#change_status', function() {
      ...
      $.ajax({  
         type:"POST",  
         url:'<?=base_url()?>admin/company/allcompany/update_company_status',  
         data:{status: status, id:id},  
         success:function(data){  
          var parseData = JSON.parse(data);
          
          if(parseData.result.company_status == 1){
