...
<?php $drive_details = $this->db->get('drive')->result_array();?>
...
<script type="text/javascript">
	$(document).ready(function(){
	   	var userDataTable = $('#lowinventory').DataTable({
	      	...
	      	'pageLength':25,
	      	'ajax': {
	          'url':'<?=base_url()?>admin/reporting/completedresult/addinventory_api',
	          'data': function(data){
            ...
            "buttons": [
                {
                    ...
                    "filename": function () {
                        return 'Compelete drives result';
                    },
                },
